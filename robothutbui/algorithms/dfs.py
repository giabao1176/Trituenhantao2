def solve_dfs(M, N, start_pos, initial_dirty, obstacles, style):
    frontier = [(start_pos, frozenset(initial_dirty))]
...
def solve_dfs_stepwise(M, N, start_pos, initial_dirty, obstacles, style):
    frontier = [(start_pos, frozenset(initial_dirty))]
    visited = {(start_pos, frozenset(initial_dirty))}
    parent = {(start_pos, frozenset(initial_dirty)): (None, None)}
